...
const SET_FORGOT_FORM_EMAIL = "SET_FORGOT_FORM";
const RESET_FORGOT_FORM_EMAIL_SENT = "RESET_FORGOT_FORM_EMAIL_SENT";
...
const _setForgotFormEmailSent = bool => ({
  type: RESET_FORGOT_FORM_EMAIL_SENT,
  bool
});
...
export const requestToken = email => dispatch =>
